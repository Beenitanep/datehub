  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <!--  menu block start
        ...
        <li><a href="{{ URL::to('/date-facts') }}">Date Tips</a></li>
        <li><a href="{{ URL::to('/find-date') }}">Find a Date</a></li>
         <li><a href="#">Plan a Date</a></li>
         <li><a href="#">Date Shop</a></li>
          <li><a href="#">Trending</a></li>
         <li><a href="#">Travel</a></li>
         menu block start  -->
         <?php //$menuName=[]; ?>
         @foreach ($homemenu as $menu)
         <li class="active"><a href="{{ URL::to('/') }}">{{ $menu->name }}<span class="sr-only">(current)</span></a></li>
